        ...
        <DashboardLayout>
            <Box width="100%">
                        ...
                        <CardContent className={classes.formContents}>
                            ...
                            {state.uploadTravelHistory && (
                                <div className={classes.fileInputLabel}>
                                    ...
                                    />
                                    {state.Errors?.has('travelHistoryFile') && (
                                        <FormHelperText
                                            error={state.Errors?.has(
                                                'travelHistoryFile',
                                            )}
                            ...
                            <TextField
                                required
                                fullWidth
                                error={state.Errors?.has('ovChipkaartNumber')}
                                helperText={
                                ...
                                onChange={(event: any) => {
                                    setState({
                                        ...state,
                                        OvChipkaartNumber: event.target.value,
                                    });
                                }}
                            />
                            ...
                            <Box display="flex" className={classes.gap1}>
                                ...
                                <TextField
                                    ...
                                    helperText={
                                        state.Errors?.first('endDate')?.message
                                    }
                                    type="date"
                                    size="small"
                                    key="endDate"
                ...
                <Card className={classes.recentRequests}>
                    <CardContent>
                        <Typography variant="h4">Recent Requests</Typography>
